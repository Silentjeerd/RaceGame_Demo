...
public class EvolutionManager : MonoBehaviour
{
    ...
    public void StartEvolution()
    {
        ...
        if (SaveStatistics)
        {
            statisticsFileName = "Evaluation - " + "RaceGameDemoTrack1" + " " + DateTime.Now.ToString("yyyy_MM_dd_HH-mm-ss");
    ...
    private void WriteStatisticsFileStart()
    {
        File.WriteAllText(statisticsFileName + ".txt", "Evaluation of a Population with size " + PopulationSize + 
                ", on Track \"" + "RaceGameDemoTrack1" + "\", using the following GA operators: " + Environment.NewLine +
    ...
    {
        //Check arguments
        if (intermediatePopulation.Count < 2) throw new System.ArgumentException("The intermediate population has to be at least of size 2 for this operator.");
